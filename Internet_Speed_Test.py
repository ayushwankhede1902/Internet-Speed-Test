...
# icon
image_icon = PhotoImage(file="C://Users//Ayush//Pictures//GUI//logo1.png")
root.iconphoto(False, image_icon)



# Images
Top = PhotoImage(file="C://Users//Ayush//Pictures//GUI//top.png")
Label(root, image=Top, bg="#1a212d").pack()

Main = PhotoImage(file="C://Users//Ayush//Pictures//GUI//main.png")
Label(root, image=Main, bg="#1a212d").pack(pady=(40, 0))

button = PhotoImage(file="C://Users//Ayush//Pictures//GUI//button.png")
Button(root, image=button, bg="#1a212d", bd=0, activebackground="#1a212d", cursor="hand2", command=Check).pack(pady=10)



#label
Label(root, text="PING", font="arial 10 bold", bg="#384856").place(x=50, y=0)
Label(root, text="DOWNLOAD", font="arial 10 bold", bg="#384856").place(x=140, y=0)
